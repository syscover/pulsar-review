...
class Poll extends CoreModel
{
    ...
    protected $fillable     = ['name', 'send_notification', 'validate', 'default_score', 'mailing_days', 'expiration_days', 'review_route', 'review_email_template', 'comment_email_template'];
